    ...
    try {
        ...
        switch (dbChoice) {
            ...
            case "2":
                ...
                dbUri = await askQuestion("Enter your MongoDB Compass connection string (default: mongodb://localhost:27017/alielian): ") || "mongodb://localhost:27017/alielian";
                break;
            case "3":
                dbType = "community";
                console.log("\n📊 MongoDB Community Configuration");
                dbUri = await askQuestion("Enter your MongoDB Community connection string (default: mongodb://localhost:27017/alielian): ") || "mongodb://localhost:27017/alielian";
                break;
            default:
