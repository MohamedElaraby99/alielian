...
const dbConfig = {
    ...
    atlas: {
        uri: process.env.MONGO_URI_ATLAS || "mongodb://localhost:27017/alielian_database",
        options: {
    ...
    compass: {
        uri: process.env.MONGO_URI_COMPASS || "mongodb://localhost:27017/alielian_database",
        options: {
            useNewUrlParser: true,
            useUnifiedTopology: true,
        }
    ...
    community: {
        uri: process.env.MONGO_URI_COMMUNITY || "mongodb://localhost:27017/alielian_database",
        options: {
            useNewUrlParser: true,
            useUnifiedTopology: true,
        }
