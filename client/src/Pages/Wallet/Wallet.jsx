                                ...
                                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
                                    ...
                                    <ul className="space-y-2 text-blue-800 dark:text-blue-200">
                                        <li className="flex items-start">
                                            ...
                                            تواصل معنا على واتساب: <strong> 01143982522</strong> للحصول على كود شحن
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-blue-600 dark:text-blue-400 ml-2">•</span>
                                            أو ادفع عبر فودافون كاش: <strong>01143982522</strong>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="text-blue-600 dark:text-blue-400 ml-2">•</span>
                                            ...
                                            <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded border border-green-200 dark:border-green-600">
                                                ...
                                                <button
                                                    onClick={() => {
                                                        ...
                                                        window.open(`https://wa.me/201143982522?text=${encodeURIComponent(message)}`, '_blank');
                                                    }}
