            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  مرحباً بك في نظام إدارة التعلم من المنصة الدولية. من خلال الوصول إلى منصتنا واستخدامها، 
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 dark:text-gray-300">
                    تقدم شركة المنصة الدولية المحتوى التعليمي والخدمات "كما هي" دون ضمانات.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-8">
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  من خلال استخدام منصة شركة المنصة الدولية، فإنك تقر بأنك قد قرأت وفهمت 
