            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  مرحباً بك في نظام إدارة التعلم من منصة  الدولية. من خلال الوصول إلى منصتنا واستخدامها، 
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 dark:text-gray-300">
                    ...
                    مملوك لشركة منصة  الدولية أو المرخصين لها ومحمي بقوانين حقوق النشر.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300">
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 dark:text-gray-300">
                    تقدم شركة منصة  الدولية المحتوى التعليمي والخدمات "كما هي" دون ضمانات.
                  </p>
                  <p className="text-gray-700 dark:text-gray-300">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6 mt-8">
                <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                  من خلال استخدام منصة شركة منصة  الدولية، فإنك تقر بأنك قد قرأت وفهمت 
