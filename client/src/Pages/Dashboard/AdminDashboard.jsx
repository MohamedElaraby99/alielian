          ...
          <div className="relative z-10 container mx-auto">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl shadow-lg lg:shadow-xl p-4 lg:p-6 mb-8 lg:mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                ...
                {/* إدارة فئات المراحل */}
                <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-4 lg:p-6 text-white hover:from-purple-600 hover:to-purple-700 transition-all duration-200 transform hover:scale-105 cursor-pointer shadow-lg hover:shadow-xl" onClick={() => navigate("/admin/stage-categories")}>
                  <div className="flex items-center justify-between mb-3">
                    <FaList className="text-2xl lg:text-3xl text-purple-200" />
                    <div className="w-3 h-3 bg-purple-200 rounded-full animate-pulse"></div>
                  </div>
                  <h4 className="text-lg lg:text-xl font-bold mb-2">إدارة فئات المراحل</h4>
                  <p className="text-purple-100 text-sm lg:text-base opacity-90">إدارة فئات المراحل الدراسية</p>
                  <div className="mt-4 flex items-center justify-between">
